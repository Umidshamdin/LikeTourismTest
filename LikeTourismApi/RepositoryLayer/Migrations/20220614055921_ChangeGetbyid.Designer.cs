...
namespace RepositoryLayer.Migrations
{
    ...
    [Migration("20220614055921_ChangeGetbyid")]
    partial class ChangeGetbyid
    {
            ...
            modelBuilder.Entity("DomainLayer.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 14, 9, 59, 21, 307, DateTimeKind.Local).AddTicks(7423));
            ...
            modelBuilder.Entity("DomainLayer.Entities.FamousCity", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 9, 59, 21, 291, DateTimeKind.Local).AddTicks(4658));
            ...
            modelBuilder.Entity("DomainLayer.Entities.HotelList", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 9, 59, 21, 301, DateTimeKind.Local).AddTicks(5484));
            ...
            modelBuilder.Entity("DomainLayer.Entities.House", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 9, 59, 21, 306, DateTimeKind.Local).AddTicks(6988));
            ...
            modelBuilder.Entity("DomainLayer.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 9, 59, 21, 303, DateTimeKind.Local).AddTicks(5488));
            ...
            modelBuilder.Entity("DomainLayer.Entities.RoomImages", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 9, 59, 21, 308, DateTimeKind.Local).AddTicks(1947));
            ...
            modelBuilder.Entity("DomainLayer.Entities.Slider", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 14, 9, 59, 21, 302, DateTimeKind.Local).AddTicks(9056));
