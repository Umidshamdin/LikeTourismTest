...
namespace RepositoryLayer.Migrations
{
    ...
    [Migration("20220612150429_HotelListIdAdded")]
    partial class HotelListIdAdded
    {
            ...
            modelBuilder.Entity("DomainLayer.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 12, 19, 4, 29, 205, DateTimeKind.Local).AddTicks(642));
            ...
            modelBuilder.Entity("DomainLayer.Entities.FamousCity", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 12, 19, 4, 29, 189, DateTimeKind.Local).AddTicks(4777));
            ...
            modelBuilder.Entity("DomainLayer.Entities.HotelList", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 12, 19, 4, 29, 199, DateTimeKind.Local).AddTicks(1238));
            ...
            modelBuilder.Entity("DomainLayer.Entities.House", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 12, 19, 4, 29, 204, DateTimeKind.Local).AddTicks(5));
            ...
            modelBuilder.Entity("DomainLayer.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 12, 19, 4, 29, 201, DateTimeKind.Local).AddTicks(763));
            ...
            modelBuilder.Entity("DomainLayer.Entities.RoomImages", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 12, 19, 4, 29, 205, DateTimeKind.Local).AddTicks(5052));
            ...
            modelBuilder.Entity("DomainLayer.Entities.Slider", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 12, 19, 4, 29, 200, DateTimeKind.Local).AddTicks(4028));
