...
namespace RepositoryLayer.Migrations
{
    ...
    [Migration("20220620081054_CreatedRole")]
            ...
            modelBuilder.Entity("DomainLayer.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 20, 12, 10, 54, 250, DateTimeKind.Local).AddTicks(3360));
            ...
            modelBuilder.Entity("DomainLayer.Entities.FamousCity", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 20, 12, 10, 54, 238, DateTimeKind.Local).AddTicks(1510));
            ...
            modelBuilder.Entity("DomainLayer.Entities.HotelDescription", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 20, 12, 10, 54, 252, DateTimeKind.Local).AddTicks(722));
            ...
            modelBuilder.Entity("DomainLayer.Entities.HotelList", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 20, 12, 10, 54, 244, DateTimeKind.Local).AddTicks(3977));
            ...
            modelBuilder.Entity("DomainLayer.Entities.HotelListImages", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 20, 12, 10, 54, 251, DateTimeKind.Local).AddTicks(3576));
            ...
            modelBuilder.Entity("DomainLayer.Entities.House", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 20, 12, 10, 54, 249, DateTimeKind.Local).AddTicks(3053));
            ...
            modelBuilder.Entity("DomainLayer.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 20, 12, 10, 54, 246, DateTimeKind.Local).AddTicks(4440));
            ...
            modelBuilder.Entity("DomainLayer.Entities.RoomImages", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 20, 12, 10, 54, 250, DateTimeKind.Local).AddTicks(8465));
            ...
            modelBuilder.Entity("DomainLayer.Entities.Slider", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 20, 12, 10, 54, 245, DateTimeKind.Local).AddTicks(7608));
